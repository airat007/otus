...
Сценарий: Тест ввода документа "Передача товара" на основании документа "Заказ"
	...
	* Ввод "Передачи товара" на основании "Заказа" со статусом "Новый"
		...
		Тогда элемент формы с именем 'Организация' стал равен "Ромашка"
		Тогда элемент формы с именем 'Контрагент' стал равен "Береза"
		Тогда элемент формы с именем 'Склад' стал равен "Склад образцов"
		Тогда элемент формы с именем 'Заказ' стал равен "Заказ * от *" по шаблону
